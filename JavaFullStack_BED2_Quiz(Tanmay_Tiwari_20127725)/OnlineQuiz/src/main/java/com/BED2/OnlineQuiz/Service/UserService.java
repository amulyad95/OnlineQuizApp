...
public class UserService {
	...
	public void newUser(Users u,Authorities a) {
     ...
     final String uri="http://localhost:8070/addNewUser";
     
     final String url="http://localhost:8070/addNewAuthority";
	...
	public List<Users> getAllUsers() {
		...
		final String uri="http://localhost:8070/GetAllUsers";
	...
	public List<TestDetails> TestDetails(){
		...
		final String uri="http://localhost:8070/GetAllTest";
	...
	public int checkSpring(Questions q) {
		...
		int marks=0;
		final String uri="http://localhost:8070/addResult";
		String result="";
